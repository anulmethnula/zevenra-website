...
export default function ShopPage(){
 ...
 const categories=activeCategories.filter(c=>all.some(p=>getDescendantCategoryIds(c.id,data.categories).includes(p.categoryId)));
