    ...
    <Card title="Product images & video">
     <div className="grid grid-cols-2 gap-3 md:grid-cols-3 xl:grid-cols-4">
      {product.media.map((media,index)=><div key={media.url+'-'+index} className="group relative overflow-hidden border border-black/10 bg-white">
       {media.type==='video'?<video src={media.url} muted playsInline controls className="aspect-[4/5] w-full object-cover" loading="lazy" decoding="async"/>:<img src={media.url} alt={media.alt||product.name} className="aspect-[4/5] w-full object-cover" loading="lazy" decoding="async"/>}
