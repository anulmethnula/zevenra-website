...
export default async function handler(req:VercelRequest,res:VercelResponse){
 ...
 try{
  ...
  return json(res,{products,categories,collections,sizeCharts,navigation,homepageSections,settings:publicSettings(settings),deliveryRates},200,{'Cache-Control':'public, max-age=30, stale-while-revalidate=120'});
